      ...
      <section className="about-section">
        <div className="about-card">
          ...
          {loading ? (
            ...
            <div className={`repairs-grid ${selectedRepair ? 'has-detail' : ''}`}>
                ...
                <div>
                  ...
                  {selectedRepair.status === 'diagnosing' && selectedRepair.diagnostic_started_at && (
                    <div style={{
                      ...
                      <span style={{color: '#94a3b8'}}>🔍 Temps écoulé depuis le début du diagnostic:</span>
                      <TimerDisplay 
                        startTime={selectedRepair.diagnostic_started_at} 
                        maxHours={selectedRepair.diagnostic_duration_hours || 48}
                        onComplete={() => alert('🕒 Le délai de diagnostic est écoulé. Veuillez contacter le garage.')}
                      />
                    </div>
                  )}
                  ...
                  {selectedRepair.status === 'in_progress' && selectedRepair.progress_started_at && (
                    <div style={{
                      ...
                      <span style={{color: '#94a3b8'}}>🔧 Temps écoulé depuis le début des travaux:</span>
                      <TimerDisplay 
                        startTime={selectedRepair.progress_started_at} 
                        maxHours={selectedRepair.progress_duration_hours || 72}
                        onComplete={() => alert('🔧 Le délai de réparation est écoulé. Contactez le garage.')}
                      />
                    </div>
                  )}
