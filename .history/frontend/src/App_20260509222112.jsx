      ...
      <section className="hero-section" style={{ backgroundImage: `url(${heroBg})` }}>
        ...
        <div className="hero-copy">
          ...
          <p className="hero-description">Réservez un garage, suivez le diagnostic en temps réel et profitez d'un service automobile fiable près de chez vous.</p>
            <div className="hero-actions" style={{ display: 'flex', gap: '120px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link to="/garages">
    ...
    <div className="page-shell">
      ...
      <section className="about-section">
        <div className="about-card">
          ...
          <p style={{ color: '#f8fafc', marginBottom: '20px' }}>Trouvez des garages certifiés et des centres de service automobile près de chez vous !</p>
          <input
            type="text"
            className="search-input"
